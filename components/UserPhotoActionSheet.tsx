      ...
      <YStack gap="$2">
        <YGroup unstyled className='bg-[#F1f1f1]' alignItems='center' justifyContent='center' separator={<Separator />}>
          <YGroup.Item>
            ...
            }} unstyled className='bg-[#1A1A1A] text-center' size={'$4.5'} justifyContent='center'>
        ...
        <YGroup size="$4" alignItems='center' justifyContent='center' separator={<Separator />}>
          <YGroup.Item>
            <ListItem unstyled onPress={() => ref.current?.hide()} className='bg-[#1A1A1A] text-center' size={'$4.5'} justifyContent='center'>
